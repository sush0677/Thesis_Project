...
```
cd existing_repo
git remote add origin https://git.cs.bham.ac.uk/sxp11381/thesis_project.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.bham.ac.uk/sxp11381/thesis_project/-/settings/integrations)
